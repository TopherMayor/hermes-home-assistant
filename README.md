...
4. Search for **Hermes Assistant** and configure:
   - **Gateway URL** — e.g. `http://192.168.30.196:8642` (the Hermes host)
...
| Field | Value |
|-------|-------|
| `ssh_host` | IP or hostname of the machine running Hermes (e.g. `192.168.30.50`) |
...
gateway_url: http://192.168.30.196:8642
...
curl http://192.168.30.196:8642/health
